package com.laolu.train.${module}.service;
...
import com.laolu.train.${module}.domain.${Domain};
import com.laolu.train.${module}.domain.${Domain}Example;
import com.laolu.train.${module}.mapper.${Domain}Mapper;
