...
import com.laolu.train.business.domain.DailyTrain;
import com.laolu.train.business.domain.DailyTrainTicket;
import com.laolu.train.business.domain.DailyTrainTicketExample;
import com.laolu.train.business.domain.TrainStation;
import com.laolu.train.business.enums.SeatTypeEnum;
import com.laolu.train.business.enums.TrainTypeEnum;
import com.laolu.train.business.mapper.DailyTrainTicketMapper;
...
public class DailyTrainTicketService {
    ...
    public PageResp<DailyTrainTicketQueryResp> refreshQueryListCache(DailyTrainTicketQueryReq req) {
        return queryList(req);
    }

//    @Cacheable(value = "DailyTrainTicketService.queryList",  condition = "#req.trainCode == 'D1'")
